...
$sql= sprintf( "select data_1,data_2,data_3 from fever.md_data where md_data.type = 5 and md_data.baby_id='%s'",$babyid);
...
<body>
<br>
<center><h1>종합레포트 history</h1></center>
<table border width="600" cellpadding="5" align="center">
    ...
    <?php
    for($i=0;$i<$j;$i++) {
        echo "<tr><td align = 'center'>" . $s3[$i][0] . "</td><td align ='center'>" . $s3[$i][1] . "</td><td align ='center'>" . $s3[$i][2] . "</td></tr>";
    }
    ?>
</table>
</body>
